module.exports = {
  ...
  siteCover:
    "http://lancedesign.org/en/wp-content/uploads/2016/05/Website-Design-Background-1.jpg", // Optional, the cover image used in header for home page. e.g: "/images/blog-cover.jpg",
  siteNavigation: true, // If navigation is enabled the Menu button will be visible
  siteRss: "/rss.xml", // Path to the RSS file.
  siteRssAuthor: "Riguel Figueiro", // The author name used in the RSS file
  // siteFBAppID: "1825356251115265", // optional, sets the FB Application ID for using app insights
  sitePaginationLimit: 5, // The max number of posts per page.
  googleAnalyticsID: "UA-111982167-1", // GA tracking ID.
  disqusShortname: "riguelblog", // enables Disqus comments, visually deviates from original Casper theme.
  siteSocialUrls: [
    "https://github.com/riguelbf",
    "https://twitter.com/rbfz800",
    "mailto:riguel@dkosoftware.com.br"
  ],
  ...
  userLinks: [
    ...
    {
      label: "Twitter",
      url: "https://twitter.com/rbfz800",
      iconClassName: "fa fa-twitter" // Disabled, see Navigation.jsx
    },
    {
      label: "Email",
      url: "riguel@dkosoftware.com.br",
      iconClassName: "fa fa-envelope" // Disabled, see Navigation.jsx
    }
  ],
  // Copyright string for the footer of the website and RSS feed.
  copyright: {
    label: "Riguel Figueiro" // Label used before the year
